...
using static MessageHandlingSystem.Application.Contracts.MessageSources.CreatePhoneMessageSource;

namespace MessageHandlingSystem.Application.MessageSources;

public class CreatePhoneMessageSourceHandler : IRequestHandler<Command, Response>
{
    private readonly IDataBaseContext _dbContext;

    public CreatePhoneMessageSourceHandler(IDataBaseContext dbContext)
    {
    ...
    {
        var source = new PhoneMessageSource(Guid.NewGuid(), request.PhoneNumber);
